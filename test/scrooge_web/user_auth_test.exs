defmodule ScroogeWeb.UserAuthTest do
  use ScroogeWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Scrooge.Accounts
  alias ScroogeWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ScroogeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ScroogeWeb.Endpoint.subscribe(live_socket_id)
